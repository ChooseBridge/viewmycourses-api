...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            ...
            @endforeach
            <form class="form-horizontal" method="post" action="{{route('backend.district.add.post')}}">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    <label>学区名称</label>
                    <input type="text" class="form-control" name="school_district_name" placeholder="学院名称">
                </div>
